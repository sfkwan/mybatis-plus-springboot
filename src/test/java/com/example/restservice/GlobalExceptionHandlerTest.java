...
class GlobalExceptionHandlerTest {
        ...
        void testApiExceptionHandlingWithFieldErrors() {
                ...
                ApiException apiException = new ApiException(HttpStatus.BAD_REQUEST, "Validation failed",
                                "VALIDATION_ERROR",
                                fieldErrors);
                MockHttpServletRequest request = new MockHttpServletRequest();
        ...
        void testGlobalExceptionHandling() {
                ...
                // When
                ResponseEntity<ErrorResponse> response = exceptionHandler.handleGlobalException(runtimeException,
                                request);
        ...
        void testValidationExceptionHandling() throws NoSuchMethodException {
                ...
                bindingResult.addError(
                                new FieldError("user", "name", null, false, new String[] { "NotBlank" }, null,
                                                "Name is required"));
